...
header('Access-Control-Allow-Headers: Content-Type, Content-Range, Content-Disposition, Content-Description, Accept, AuthorizationToken');
    ...
    $q = "SELECT cms_news.news_id, cms_news.news_name, cms_news.news_lead, cms_news.news_content, 
    ...
    WHERE cms_news_group.news_group_id = '$id' AND cms_news.news_status != '1' AND cms_news.news_pub_date<='$today'";
